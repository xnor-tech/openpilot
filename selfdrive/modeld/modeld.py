...
def main(demo=False):
  ...
  while True:
    ...
    lat_smooth_seconds = get_lat_smooth_seconds(v_ego, LAT_SMOOTH_SECONDS)
    ...
    if model_output is not None:
      ...
      action = get_action_from_model(model_output, prev_action, lat_delay + frame_delay + action_delay, long_delay + frame_delay + action_delay, v_ego, lat_smooth_seconds)
      prev_action = action

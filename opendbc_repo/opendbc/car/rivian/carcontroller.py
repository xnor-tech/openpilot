...
class CarController(CarControllerBase):
  ...
  def update(self, CC, CC_SP, CS, now_nanos):
    ...
    lat_active = CC.latActive and abs(CS.out.steeringAngleDeg) < MAX_STEERING_ANGLE
    can_sends = []
    ...
    can_sends.append(create_lka_steering(self.packer, self.frame, CS.acm_lka_hba_cmd, apply_torque, CC.enabled, lat_active))

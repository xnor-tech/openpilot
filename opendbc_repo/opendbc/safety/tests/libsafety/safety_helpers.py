...
class PandaSafety(Protocol):
  ...
  def set_desired_steer_power_last(self, power: int) -> None: ...
  def set_desired_curvature_last(self, curvature: int) -> None: ...
  def get_desired_curvature_last(self) -> int: ...
  def set_curvature_meas(self, min: int, max: int) -> None: ...
  def get_curvature_meas_min(self) -> int: ...
  def get_curvature_meas_max(self) -> int: ...

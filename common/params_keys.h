...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"TeslaAccBlendEnabled", {PERSISTENT, BOOL, "0"}},
    ...
    {"TinklaHandsOnLevel", {PERSISTENT, FLOAT, "3.0"}},
    {"TinklaHsoNumbPeriod", {PERSISTENT, FLOAT, "1.5"}},
    {"TinklaIgnoreStockAeb", {PERSISTENT, BOOL, "0"}},
    {"TinklaPedalEnabled", {PERSISTENT, BOOL, "0"}},
